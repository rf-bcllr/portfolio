    ...
    <div className="relative">
      ...
      <div className="hidden md:block">
        <div className="flex justify-between items-start relative">
          ...
          <div className="absolute top-3 left-0 h-[2px] bg-primary/50" style={{ width: '100%' }} />
          ...
          {steps.map((step, index) => (
            ...
            >
              {/* Dot */}
              <div className="w-6 h-6 rounded-full bg-primary border-4 border-background mb-4" />
      ...
      <div className="md:hidden">
        <div className="relative pl-8">
          {/* Vertical line */}
          <div className="absolute left-3 top-0 bottom-0 w-[2px] bg-primary/30" />
          ...
          {steps.map((step, index) => (
            ...
            >
              {/* Dot */}
              <div className="absolute left-[-20px] w-4 h-4 rounded-full bg-primary border-2 border-background" />
