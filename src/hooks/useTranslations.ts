export const translations = {
  en: {
    ...
    designProcessIterate: {
      title: "Iterate",
      description: "Generate as many ideas as possible. Do not be afraid to experiment and try out new ideas. Sketch, create wireframes, build prototypes (with and without AI). Repeat."
    },
    designProcessLaunch: {
      title: "Launch",
