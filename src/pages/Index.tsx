...
import projectThumbNew1 from "@/assets/project-thumb-new-1-upscaled.jpg";
import projectThumbNew2 from "@/assets/project-thumb-new-2-upscaled.jpg";
import riskAnalysisUpscaled from "@/assets/risk-analysis-upscaled.png";
...
const Index = () => {
  ...
  const projectMedia = [
    ...
    { src: riskAnalysisUpscaled, href: "https://bento.me/rfbcllr", title: "Risk Analysis Dashboard - Cybersecurity Interface" },
