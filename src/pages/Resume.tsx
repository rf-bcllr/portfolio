...
const experiences = [
  ...
  { title: "Product Designer", company: "isaac", period: "2024 - 2025", description: "End-to-end digital product design, design system and scalable interfaces.", chips: ["Fintech", "B2B", "B2C", "SaaS"] },
